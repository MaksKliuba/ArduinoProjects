...
#define LEFT_MOTOR_ENB_PIN 3
#define LEFT_MOTOR_IN3_PIN 5
#define LEFT_MOTOR_IN4_PIN 4 

#define RIGHT_MOTOR_ENA_PIN 6
#define RIGHT_MOTOR_IN1_PIN 7
#define RIGHT_MOTOR_IN2_PIN 8

#define LEFT_MOTOR_MIN_SPEED 30
#define RIGHT_MOTOR_MIN_SPEED 40
...
GMotor leftMotor(DRIVER3WIRE, LEFT_MOTOR_IN3_PIN, LEFT_MOTOR_IN4_PIN, LEFT_MOTOR_ENB_PIN, HIGH);
GMotor rightMotor(DRIVER3WIRE, RIGHT_MOTOR_IN1_PIN, RIGHT_MOTOR_IN2_PIN, RIGHT_MOTOR_ENA_PIN, HIGH);
...
void loop() {
  ...
  while (radio.available(&pipeNo)) {
    ...
    digitalWrite(FIRST_LED_PIN, recievedData[8]);
    digitalWrite(SECOND_LED_PIN, recievedData[9]); 
