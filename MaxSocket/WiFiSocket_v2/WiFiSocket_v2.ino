...
WiFiLed ledWiFi(2, false);

Output output1(4, 1, false, true);
Output output2(5, 3, false, true);
Output output3(13, 15, false, true);

Button button1(12, INPUT_PULLUP);
Button button2(14, INPUT_PULLUP);
Button button3(16, INPUT_PULLUP);
...
//const char* password = "qwerty12345678";

const char* ssid = "TP-LINK TL-WR841N";                                            
const char* password = "07101973";

IPAddress ip(192, 168, 0, 17); // Node static IP
